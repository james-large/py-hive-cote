...
if __name__ == "__main__":
    ...
    cls ="BOSSPY"
    problem_list="D:/CMP Machine Learning/Datasets/TSC Archive/datasets.txt"
...
#                classifier = rf.RotationForest(n_estimators=200)
            ...
            defaultTrainTestFold(classifier,problem,"C:/Users/Matthew Middlehurst/Dropbox/sktime/Results/"+cls+"/Predictions/","D:/CMP Machine Learning/Datasets/TSC Archive/")
