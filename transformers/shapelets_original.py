...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 15:49:59 2019
...
if __name__ == "__main__":
    ...
    pipeline = Pipeline([
        ('st', RandomShapeletTransform(min_shapelet_length=10, max_shapelet_length=12, num_cases_to_sample=10, num_shapelets_to_sample_per_case=3, verbose=True)),
